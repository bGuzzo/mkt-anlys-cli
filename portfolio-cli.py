...
def validate_input_file(input_file: Path) -> list[str]:
    ...
    try:
        ...
        raise typer.BadParameter(f"Input file '{input_file}' must be a valid JSON.") from err
...
def main(
    input_file: Path = typer.Option(
        ..., "--input", help="Path to a JSON file containing a list of yfinance tickers."
    ),
    ...
    Example:
    uv run portfolio-cli.py --input configs/ibkr_portfolio_list.json
      --amount 3000 --outfile portfolio_res/ibkr_allocation_3k.csv
    """
